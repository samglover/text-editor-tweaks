...
A super-simple WordPress plugin that improves both tabs of the WordPress editor with better fonts and improved typography.
...
1. Visual editor comparison. *Note: This shows the default Visual editor styles; your theme may modify the default styles.*
2. Text editor comparison.
...
* Remove nonstandard styles from tinymce-editor-styles.css.
...
* Add a stylesheet for the TinyMCE/Visual editor.
* Change name from Text Editor Tweaks to WP Editor Tweaks.
* Add to WordPress Plugin Directory.


= 1.0 =

* Change text editor font to Source Code Pro and increase the font size.
